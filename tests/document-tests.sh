...
$IPPFIND --literal-name "${TARGET}" -x $IPPTOOL -P "$PLIST" -I -T 300 '{}' document-tests.test \;

# confirm that the PLIST is well formed, if plutil is available (e.g. running on macOS)
