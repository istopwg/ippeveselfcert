...
::
:: Copyright 2014-2020 by The Printer Working Group.
::
...
set name=%1
set name=%name:~1,-1%
ippfind "%name%._ipp._tcp.local." -x ipptool -P "\"%USERPROFILE%\\Desktop\\%name% Document Results.plist\"" -I "{}" document-tests.test ";"
